...
export default function FahadCard() {
    return (<Card css={{ w: "100%", h: "400px" }}>
        <Card.Body css={{ p: 0, maxWidth: 300 }}>
            <Card.Image
                src="https://errorx-tech.com/assets/images/fahad.png"
                objectFit="cover"
                width="100%"
                height="100%"
        ...
        >
            <Col>
                <Row gap={1}>
                    <Text b size={20}>فهد القحطاني</Text>
                ...
                <Text b size={13}>UI & UX Expert ومطور واجهات ويب</Text>
            </Col>
