...
export default function IbrahimCard() {
    return (<Card css={{ w: "100%", h: "400px" }}>
        <Card.Body css={{ p: 0, maxWidth: 300 }}>
            <Card.Image
                src="https://errorx-tech.com/assets/images/ibrahim.png"
                objectFit="cover"
                width="100%"
                height="100%"
        ...
        >
            <Col>
                <Row gap={1}>
                    <Text b size={20}>إبراهيم عسيري</Text>
                ...
                <Text b size={13}>مدير قواعد بيانات</Text>
            </Col>
